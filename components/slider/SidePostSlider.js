...
export default function SidePostSlider() {
  return (
    <>
      ...
      >
        <SwiperSlide
          className="sidePost__item"
          style={{
            backgroundImage: 'url("/assets/img/category/side_post01.jpg")',
            width: 300,
          }}
        >
          <div className="sidePost__content">
            ...
            <h5 className="title tgcommon__hover">
              <Link href="/article/scientists-speculate-that-ours-might-not-be-held">
                Tips for helping to make an your startup a success
              </Link>
            </h5>
          </div>
        </SwiperSlide>
        <SwiperSlide
          className="sidePost__item"
          style={{
            backgroundImage: 'url("/assets/img/category/side_post02.jpg")',
            width: 300,
          }}
        >
          <div className="sidePost__content">
        ...
        <SwiperSlide
          className="sidePost__item"
          style={{
            backgroundImage: 'url("/assets/img/category/side_post03.jpg")',
            width: 300,
          }}
        >
          <div className="sidePost__content">
