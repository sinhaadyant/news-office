  ...
  return (
    <>
      ...
      <Layout
        headerStyle={3}
        footerStyle={2}
        footerClass="footer-style-three white-bg"
      >
              ...
              <div className="col-xl-6 col-lg-8 order-0 order-xl-2">
                <div className="tgbanner__big-post text-center">
                  ...
                  <div className="tgbanner__big-post-content">
                    ...
                    <Link href="/article/52" className="read-more">
                  ...
                  <div className="featured__post">
                    <Link href={`/article/${item.id}`}>
                      <div
                        ...
                        style={{
                          backgroundImage: `url(/assets/img/travel/${item.img})`,
                        }}
                      />
                    </Link>
